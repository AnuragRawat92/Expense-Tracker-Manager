...
const HomePage = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const requiredFields = ["amount", "type", "category", "description", "date"];
      ...
      if (editable) {
        ...
        await axios.post("/api/v1/transactions/add-transaction", payload);
...
>
  <Form
    ...
    initialValues={
      editable
        ? { ...editable, date: moment(editable.date).format("YYYY-MM-DD") }
  ...
  >
    ...
    <Form.Item label="Category" name="category">
      <Select>
        ...
        <Select.Option value="business">Business Profit</Select.Option>
